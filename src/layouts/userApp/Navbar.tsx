    ...
    <nav className="block w-full bg-transparent text-texto px-1 md:px-4 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="relative flex justify-end w-full">
          <Link className="inline-block xl:hidden py-2 px-6 leading-loose bg-principal hover:bg-secondario hover:text-texto text-sm text-white font-bold rounded-xl transition duration-200 md:mr-4" to="/app/registrate">
            Paga mi cuota
          </Link>
          <div
