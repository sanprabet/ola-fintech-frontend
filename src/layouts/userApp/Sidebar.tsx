  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 p-6 bg-gray-100 border-b border-gray-300">
        ...
        <div>
          <p className="text-sm text-gray-700">Bienvenido <br /> {userName}</p>
      ...
      <div className="m-4 flex-grow">
        ...
        <ul className="flex flex-col gap-4">
          ...
          */}
          <li>
            <Link to="/app/miCuenta" className={getLinkClasses('/app/miCuenta')}>
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-inherit" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="px-4 pb-3">
        {/* TODO: Añadir link "tag a" de pasarela de pagos */}
        <Link to="/app/formularioCredito" className="block w-full py-4 text-center text-lg font-semibold text-white bg-principal rounded-lg hover:bg-principalToneDown">
          Pedir mi credito
        </Link>
      </div>
      <div className="pb-4">
